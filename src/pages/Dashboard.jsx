        ...
        <LayoutDashboard className="dashboard-home">
            ...
            <div>
                        ...
                        <div className="ranking-stats">
                            ...
                            <div>
                                <div>
                                    ...
                                    <span>
                                        {userData?.created_challenges?.length ||
                                            0}
                                    </span>
                                </div>
                                <div>
                            ...
                            <div>
                                <div>
                                    <p>Score mensuel</p>
                                    <span>
                                        {challengesDone?.length > 0 ? calculateMonthlyScore(challengesDone, year, month ) : 0}
                                    </span>
                                </div>
                                <div>
                                    {theme === 'light' ? (
                ...
                <div className="dashboard-home--challenges">
                    ...
                    <div className="link">
                        <Link to={'/challenges_list'}>
                            Voir d’autres challenges{' '}
                            {theme === 'light' ? (
                                <ArrowRight className="arrow-right" />
                            ) : (
                                <ArrowRightWhite className="arrow-right" />
                            )}
                        </Link>
                    </div>
                </div>
